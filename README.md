...
Este projeto foi desenvolvido durante a Imersão IA, uma iniciativa da [Alura](https://www.alura.com.br/) em parceria com o [Google Gemini](https://gemini.google.com/app), com o objetivo de explorar o potencial da inteligência artificial generativa. O desafio proposto consistia em criar uma aplicação inovadora utilizando exclusivamente a [API do Google Gemini](https://ai.google.dev/gemini-api/docs?hl=pt-br). Diante do desafio, surgiu o FisicaAI, uma solução revolucionária que estimula o aprendizado ativo, desperta o pensamento computacional e promove a autonomia dos alunos. Ao possibilitar que os estudantes interajam com a ferramenta e acompanhem cada etapa do raciocínio, a FisicaAI oferece uma experiência de aprendizado personalizada, fortalecendo a autoconfiança por meio de soluções práticas e explicações claras.
